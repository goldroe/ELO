...
void Resolver::resolve_call_expr(Ast_Call *call) {
    ...
    int total_arg_count = get_values_count(call->arguments);
    int total_param_count = type_value_count(proc_type->params);
